...
const SmallProductCard = ({name, price, picture, color, category}) => {
    return (
        <div className={`flex-shrink-0 m-6 relative overflow-hidden ${color} rounded-lg max-w-xs shadow-lg`}>
            <svg
            ...
            <div className="relative pt-10 px-10 flex items-center justify-center">
                ...
                ></div>
                <img className="relative w-40" src={picture} alt={name} />
            </div>
