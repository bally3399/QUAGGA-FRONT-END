                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                            ...
                            <div className="col-span-4 sm:col-span-9">
                                <div className="bg-white shadow rounded-lg p-6">
                                    ...
                                    <p className="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Sed finibus est
                                        vitae tortor ullamcorper, ut vestibulum velit convallis. Aenean posuere risus
                                        non velit egestas
                                        suscipit. Nunc finibus vel ante id euismod. Vestibulum ante ipsum primis in
                                        faucibus orci luctus
                                        et ultrices posuere cubilia Curae; Aliquam erat volutpat. Nulla vulputate
                                        pharetra tellus, in
                                    ...
                                    <div className="flex justify-center items-center gap-6 my-6">
                                        ...
                                        <a className="text-gray-700 hover:text-orange-600"
                                           ...
                                           target="_blank">
                                            <svg className="h-6" xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 512 512">
                                                <path fill="currentColor"
